...
nmap('gog', function() require('neogit').open({ kind = 'floating' }) end, 'Open neogit in split')
...
nmap('goc', function() vim.cmd((orien() == 'vertical' and 's' or 'vs') .. 'plit') vim.cmd('te') end, 'Open terminal in split')
nmap('goC', function() vim.cmd('te') end, 'Open terminal in current window')
nmap('goo', function() require('oil').open() end, 'Open Oil in current buffer')
