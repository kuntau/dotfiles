...
===================
  ...
  * chore(zsh): tweak `install` script output
  * ref(zsh): move os/system specific configs
...
===================
  ...
  * chore(zsh): update `enhancd` repo url

v4.1.0 / 2025-10-25
===================

  * feat(script): add helper scripts to help we manage photos
  * chore(cli): add `aria2` config file
  * docs: Update README
...
===================
  ...
  * Revert "chore(nvim): remove `dressing.nvim`"
